    ...
    image_box.innerHTML = `
     <div class="card">
        ...
        <div class="content">
          ...
          <p><strong>IMDB Rating:</strong> <i class="fa fa-star" aria-hidden="true"></i> ${anime.score}</p> 
        </div>
       </div>`;
...
loader_image.setAttribute("src","http://lindseyfurniture.com/zira/loading.gif");
...
<div class="image">
<img src="images/img-5.jpeg"  alt="image"/>
<div class="anime_name">
<span> <p class="gallery-text">Ani</p> </span>
</div>
<div class="text-image">
<span> <i class="fa fa-eye" aria-hidden="true"></i></span>
</div>
